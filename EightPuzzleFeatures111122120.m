classdef EightPuzzleFeatures111122120 < EightPuzzleFeatures
...
% approximation.
    methods
        function G = generateG(obj)
            ...
            Gval = subgoalVal();
            G(obj.aggrPermToAggrIndex([1 1 1 1 2 2 1 2 0])) = Gval;
        end
                
        function p = aggrMap(~)
            p = [0 1 1 1 1 2 2 1 2 9];
        end
        
        function obj = EightPuzzleFeatures111122120(ep)
