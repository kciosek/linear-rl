classdef EightPuzzleFeatures123499790 < EightPuzzleFeatures
...
% approximation.
    methods
        function G = generateG(obj)
            ...
            Gval = subgoalVal();
            G(obj.aggrPermToAggrIndex([1 2 3 4 9 9 7 9 0])) = Gval;
            G(obj.aggrPermToAggrIndex([1 2 3 4 9 9 7 0 9])) = Gval;
            G(obj.aggrPermToAggrIndex([1 2 3 4 9 0 7 9 9])) = Gval;
            G(obj.aggrPermToAggrIndex([1 2 3 4 0 9 7 9 9])) = Gval;
         end
                
        function p = aggrMap(~)
            p = [0 1 2 3 4 9 9 7 9 9];
        end
        
        function obj = EightPuzzleFeatures123499790(ep)
