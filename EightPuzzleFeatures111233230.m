classdef EightPuzzleFeatures111233230 < EightPuzzleFeatures
...
% approximation.
    methods
        function G = generateG(obj)
            ...
            Gval = subgoalVal();
            G(obj.aggrPermToAggrIndex([1 1 1 2 3 3 2 3 0])) = Gval;
        end
              
        function p = aggrMap(~)
            p = [0 1 1 1 2 3 3 2 3 9];
        end
        
        function obj = EightPuzzleFeatures111233230(ep)
